...
$tmp = 'В Министерстве промышленности и торговли и Министерстве иностранных дел Чехии не смогли подтвердить информацию о командировке Труханова в Прагу.';
    ...
    <form id='mainForm' method="post" enctype="multipart/form-data">
        <div class="row">
            <div class="col-8">
                ...
                <div class="form-group">
                    <label for="exampleTextarea"><b>Тексти</b></label>
...
*/
        ...
        // разрешить использовать тэг <CODE>
        // разрешить использовать определенный тэк (тут STYLE)
        ...
        CKEDITOR.instances.ckeditor.setData('<?= $tmp ?>', function () {
